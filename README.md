...
The 'Boundary Connectivity Project' is a proof of concept to showcase Boundary's inherent capabilities with regards to: 

1. Single Sign On Access to various HashiCorp components
2. Team Workflow Standardization (HashiCorp Products at Scale)
